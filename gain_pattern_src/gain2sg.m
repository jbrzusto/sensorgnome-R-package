%% svn: $Id: gain2sg.m 8 2010-01-13 16:34:13Z john $
%% 
...
%%
%% NOTE: this is a trivial modification of the original gain2s.m by Orfanidis,
%% in which E gain is normalized globally, rather than for the given phi0.
%% John Brzustowski, 11 Jan 2010.

function [ge,gh,th] = gain2sg(L,d,I,N,ph0)
...
%% JMB: normalize E gain to max for entire phi,theta surface, not just max for phi=phi0
%% ge = ge/max(ge);                               % normalized gains

ge = ge/U(L,d,I,pi/2,0);
gh = gh/max(gh);
